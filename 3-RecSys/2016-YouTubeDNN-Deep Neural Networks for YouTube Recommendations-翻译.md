# 2016-YouTubeDNN-Deep Neural Networks for YouTube Recommendations

> Paul Covington, Jay Adams, Emre Sargin | Google



Summary: 本文介绍了YouTube推荐系统的深度神经网络架构。核心内容：

- 提出两阶段推荐架构：候选生成（极多类分类+采样softmax）和排序（加权逻辑回归优化观看时间）
- 引入Example Age特征解决视频流行度的非平稳性问题
- 深度神经网络通过嵌入层融合异构信号（观看历史、搜索历史、人口统计特征）
...
- **深度 1**：256 ReLU
- **深度 2**：512 ReLU \rightarrow 256 ReLU
- **深度 3**：1024 ReLU \rightarrow 512 ReLU \rightarrow 256 ReLU
- **深度 4**：2048 ReLU \rightarrow 1024 ReLU \rightarrow 512 ReLU \rightarrow 256 ReLU
