...
> Yan Tang, Marco Zhao | Tencent PCG
...
• **合成数据**：按照基于[13]的数据合成过程生成，以控制任务相关性。由于[13]中未提供数据合成的超参数，我们按照标准正态分布随机采样\alpha_i和\beta_i，并设置c=1、m=10、d=512以确保可复现性。为每种相关性生成了140万条具有两个连续标签的样本。
