...
![图1](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig1.png)
...
![图2](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig2.png)
...
![图3](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig3.png)
> **图 3：** ILQL、PPO 微调模型在摘要任务上相对于其对应 SFT 基线的胜率。注意比较是针对相同规模的 SFT 基线进行的（例如 6B SFT 对比 6B PPO）。OpenAI 基线（其 6B 模型相对于人工生成摘要的胜率）被包括作为参考。

![图4](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig4.png)
...
![图5](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig5.png)
> **图 5：** 奖励模型在测试集上的准确率与训练比较样本数的关系。我们观察到每 10k 个训练样本，模型准确率提升约 1.8%。

![图6](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig6.png)
...
![图7](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig7.png)
...
![图8](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig8.png)
...
![图9](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig9.png)
> **图 9：** 按规模排序的合成偏好 RM 的准确率作为训练数据规模的函数。我们看到 20B 在 120,000 样本之前样本效率最高，之后 6B 模型表现略好。

![图10](.picture/2023-trlX- A Framework for Large Scale Reinforcement Learning from Human Feedback-fig10.png)
